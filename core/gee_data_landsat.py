...
def get_full_collection(geometry, date_range, doy_range, collection): #date_range = [start_date, end_date]
    import ee
    point = geometry#ee.Geometry.Point(coords)
...
#return collection after wrs_row filtering
def getImageCollection(all_scenes,geometry):
    return all_scenes.filter("WRS_ROW < 122").filterBounds(geometry)
