...
SOURCES = \
	__init__.py \
	CCDC_retriever.py CCDC_retriever_dialog.py

PLUGINNAME = CCDC_retriever

PY_FILES = \
	__init__.py \
	CCDC_retriever.py CCDC_retriever_dialog.py

UI_FILES = CCDC_retriever_dialog_base.ui
...
QGISDIR=C:\Users\morae\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
